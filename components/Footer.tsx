        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 items-start mb-16">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/arthagroww" target="_blank" rel="noopener noreferrer" aria-label="Instagram link" className="h-10 w-10 border border-border/80 hover:border-brand-blue hover:text-brand-blue rounded-xl flex items-center justify-center transition-all duration-300 text-muted-foreground hover:text-brand-blue">
